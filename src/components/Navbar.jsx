...
export default () => {
    ...
    const CTA = { title: "LinkedIn", path: "https://www.linkedin.com/in/gabrielezigurella?trk=public_profile_browsemap", CTA: <FaLinkedin size={18} /> };
        ...
        <nav className="bg-transparent mt-6 w-full md:static md:text-sm md:border-none">
            <div className='flex flex-1 flex-row justify-between items-center mx-10'>
                ...
                <ul className='flex flex-row items-center gap-x-4 md:gap-x-2.5 mr-2'>
                    ...
                    <li><a href={CTA.path} className='hover:no-underline group'>
                        <button className='flex items-center gap-x-1 grow bg-blue-500 lg:bg-gray-800 text-slate-100 px-3 py-2 rounded-xl md:rounded-md hover:bg-blue-500 hover:shadow-md hover:shadow-blue-500/50'>
